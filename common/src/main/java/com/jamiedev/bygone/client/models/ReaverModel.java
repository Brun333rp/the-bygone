...
public class ReaverModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(80, 12).addBox(-3.0F, -12.0F, -1.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		PartDefinition UpperJaw = Body.addOrReplaceChild("UpperJaw", CubeListBuilder.create().texOffs(0, 29).addBox(-9.0F, -3.0F, -18.0F, 18.0F, 7.0F, 18.0F, new CubeDeformation(0.0F))
		.texOffs(56, 82).addBox(-8.5F, -2.5F, -17.5F, 17.0F, 7.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.0F, 9.0F, -0.6545F, 0.0F, 0.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(0, 54).addBox(-8.0F, -4.0F, -12.0F, 8.0F, 8.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, -6.0F, 4.0F, 0.0F, 0.4363F, 0.0F));
		...
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(48, 54).addBox(0.0F, -4.0F, -12.0F, 8.0F, 8.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -6.0F, 4.0F, 0.0F, -0.4363F, 0.0F));
